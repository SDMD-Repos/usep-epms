...
trait ThirdPartyApiTrait
{
    ...
    protected $hris = [
        ...
        'ALL_PARENT_OFFICES' => 'https://hris.usep.edu.ph/api/epms/department',
        // Get all colleges; params: token
        'ALL_COLLEGES' => 'https://hris.usep.edu.ph/api/epms/college',
        // Get all subunit by office id; params: token, department_id
        'OFFICE_SUBUNIT' => 'https://hris.usep.edu.ph/api/epms/structure/subunit',
        // Get all sub departments by parent ID; params: department_id, token
        'OFFICES_BY_PARENT' => 'https://hris.usep.edu.ph/api/epms/structure',
        // Get all employee by office; params: department_id, token
        'EMPLOYEES_BY_OFFICES' => 'https://hris.usep.edu.ph/api/epms/employee/department',
        // Get all employee positions; params: token
        'ALL_EMPLOYEE_POSITIONS' => 'https://hris.usep.edu.ph/api/epms/employee/position/list',
        // Get the parent details of sub department; params: department_id, token
        'GET_SUB_DEPARTMENT_PARENT' => 'https://hris.usep.edu.ph/api/epms/structure/subdepartment',
    ];
