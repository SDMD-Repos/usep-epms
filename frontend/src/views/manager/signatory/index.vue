...
import SignatoryForm from '@/components/system/Manager/Signatory/Main'
...
export default {
  ...
  computed: {
    ...mapState({
      formList: state => state.formManager.forms,
    }),
  },
  data() {
    return {
  ...
  created() {
    this.$store.dispatch('formManager/FETCH_ALL_FORMS')
  },
  methods: {
