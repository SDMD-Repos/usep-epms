    ...
    >
      <div :class="$style.air__menuTop__outer">
        ...
        <a href="javascript: void(0);" :class="$style.air__menuTop__logo">
          <div :class="$style.air__menuTop__logo__letter">A</div>
          <div :class="$style.air__menuTop__logo__name">{{ settings.logo }}</div>
          <div :class="$style.air__menuTop__logo__descr">{{ settings.description }}</div>
        </a>
